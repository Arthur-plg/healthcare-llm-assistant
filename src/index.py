...
# Thread limits configuration to prevent conflicts
...
def build_index():
    """
    Builds the FAISS vector index from clean patient reviews and exports the mapping index.
    """
    ...
    df_index.reset_index(inplace=True)  # column 'index' corresponds to FAISS vector indices
